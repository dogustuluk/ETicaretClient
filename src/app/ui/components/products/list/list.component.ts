...
export class ListComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.activatedRoute.params.subscribe(async params => {
      ...
      this.products = this.products.map<List_Product>(a => {
        const listProduct: List_Product = {
          ...
          imagePath: `${a.productImageFiles.length ? a.productImageFiles.find(a => a.showcase).path : ""}`,
          productImageFiles: a.productImageFiles
        };
